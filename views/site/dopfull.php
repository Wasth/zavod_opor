...
?>
    ...
    <div id="cardBlock">
        <div id="cardContent" class="content">
            <div id="breadcrumbs">
                <a href="/">Опоры</a> > <span id="oporaName"><?= $item->name?></span>
            </div>
            <div class="grid-c-2">
                <div>
                            ...
                            <div>
                                <?php foreach($varieties as $variety): ?>
                                    <a class="black" href="<?= Url::toRoute(['full-dop/'.$variety->id]) ?>">
                                        <h1 class="inline black"><?= $variety->name ?></h1>
                                    </a>
                                <?php endforeach; ?>
                            </div>
                        <?php endif; ?>
    ...
    <div id="detailButtons">
        <div class="content">
            ...
            <div id="schemesBlock" class="ui-window">
                <div class="modal-wrapper">
                    <div class="modal-content">
                        <?php if($variety->dopSchemes): ?>
                            <?php foreach ($variety->dopSchemes as $scheme): ?>
