...
<head>
    ...
    <?php $this->head() ?>
    <meta name="yandex-verification" content="01ad9dd2f4f692b5" />
    <meta name="description" content="Риана Групп - ЗАВОД ПО ПРОИЗВОДСТВУ ОПОР ТРУБОПРОВОДОВ">
</head>
<body>
...
<script type='text/javascript'>
    (function(){ var widget_id = '2aSx39J4O5';var d=document;var w=window;function l(){
...
<script type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter48355565 = new Ya.Metrika2({
                    id:48355565,
                    clickmap:true,
                    trackLinks:true,
